...
def get_skills(domain: str | None, role: str | None, fmt: str):
    ...
    from agentura_sdk.cli.gateway import list_skills
    import json
...
def get_domains(fmt: str):
    ...
    from agentura_sdk.cli.gateway import list_skills, list_executions
    import json
...
def get_approvals(fmt: str):
    ...
    console.print(table)
    console.print(f"\n[dim]Approve with: agentura approve <id>[/]")
    console.print(f"[dim]Reject with:  agentura approve <id> --reject[/]")
...
def get_reflexions(skill: str | None, fmt: str):
    ...
    from agentura_sdk.cli.gateway import get_analytics
    import json
