"""aspora memory <status|search|prompt> — Memory explorer commands."""
...
def memory_status(fmt: str):
    ...
    from aspora_sdk.cli.gateway import get_memory_status
...
def memory_search(query: str, limit: int, fmt: str):
    ...
    from aspora_sdk.cli.gateway import memory_search as _search
...
def memory_prompt(skill_path: str, fmt: str):
    ...
    from aspora_sdk.cli.gateway import get_prompt_assembly
