"""aspora status — Platform health check (like kubectl cluster-info)."""
...
def status():
    ...
    from aspora_sdk.cli.gateway import health_check, get_gateway_url, list_skills, get_analytics
    ...
    console.print(Panel(
        ...
        title="[bold]Aspora Platform Status[/]",
    ))
