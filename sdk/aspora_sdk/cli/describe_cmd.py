"""aspora describe <resource> <name> — Detailed view (like kubectl describe)."""
...
def describe_skill(skill_path: str):
    ...
    """
    from aspora_sdk.cli.gateway import get_skill_detail
...
def describe_execution(execution_id: str):
    ...
    from aspora_sdk.cli.gateway import get_execution
