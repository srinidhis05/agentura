"""aspora watch — Live execution feed (like kubectl get pods --watch)."""
...
def watch(skill: str | None, limit: int, interval: float):
    ...
    \b
    Examples:
      aspora watch                      # all executions
      aspora watch --skill ecm/triage   # filtered
      aspora watch --interval 5         # slower polling
    """
