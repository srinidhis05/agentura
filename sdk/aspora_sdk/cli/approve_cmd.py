"""aspora approve <execution-id> — Approve or reject a pending execution."""
...
def approve(execution_id: str, reject: bool, notes: str):
    ...
    \b
    Examples:
      aspora approve exec-abc123                     # approve
      aspora approve exec-abc123 --reject            # reject
      aspora approve exec-abc123 --notes "LGTM"      # approve with notes
      aspora approve exec-abc123 --reject --notes "Wrong format"
    """
    from aspora_sdk.cli.gateway import approve_execution
