...
from aspora_sdk.types import SkillMetadata
...
def load_reflexion_entries(skill_path: Path) -> str:
    ...
    2. Fall back to .aspora/reflexion_entries.json — exact skill-name matching
...
def _load_reflexions_from_json(
    ...
    candidates = [
        Path(os.environ.get("ASPORA_KNOWLEDGE_DIR", "")) / "reflexion_entries.json",
