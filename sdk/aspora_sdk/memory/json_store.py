...
This preserves backward compatibility with the existing .aspora/ JSON files.
"""
...
class JSONStore:
    """Knowledge layer backed by .aspora/*.json files."""

    def __init__(self, knowledge_dir: Path | None = None):
        self._dir = knowledge_dir or Path(
            os.environ.get("ASPORA_KNOWLEDGE_DIR", Path.cwd() / ".aspora")
        )
