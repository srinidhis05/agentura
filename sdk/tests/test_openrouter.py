...
class TestModelResolution:
    def test_alias_resolution(self):
        assert resolve_model("claude-sonnet-4.5") == "anthropic/claude-sonnet-4-5-20250929"
    ...
    def test_fallback_chains_exist(self):
        assert "anthropic/claude-sonnet-4-5-20250929" in FALLBACK_CHAINS
        assert len(FALLBACK_CHAINS["anthropic/claude-sonnet-4-5-20250929"]) >= 1
