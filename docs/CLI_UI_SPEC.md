# CLI-First Control Plane + Minimal UI Spec

Goal: engineers operate the platform via CLI first; UI is a thin, functional mirror.
...
- `memory prompt ecm/resolve-ticket`
