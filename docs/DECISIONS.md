...
**Why**: Onboarding configs use simpler format (`domain: "wealth"` vs nested object). Normalization layer means one parser handles both. Reduces friction for new skill authors.
