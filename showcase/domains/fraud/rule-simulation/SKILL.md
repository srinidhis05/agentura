...
1. Only simulate what the rule defines — do not invent additional conditions
2. Always interpret the results in plain English
3. Interpret but NEVER recommend actions — the analyst decides
4. Do not modify input data — no dropping rows, no filling nulls
5. No future data leakage in feature computation
6. Flag data quality issues before running simulation
...
- If verification rate > 85%, note that the rule is flagging mostly innocent customers
